...
<head>
  <!-- Title -->
  <title>SiMotor FAQ | Kontak Kami</title>
      ...
      <div class="row justify-content-center py-11">
        ...
        <!--   <form>
            <div class="row">
              ...
              <div class="col-md-6 form-group mb-4">
                <label for="c_subject">Subjek</label>
                <input class="form-control" type="text" placeholder="Aduan" id="c_subject">
              </div>

              <div class="col-md-6 form-group mb-4">
                <label for="c_phone">Telepon</label>
                <input class="form-control" type="tel" placeholder="0800-0000-0000" id="c_phone">
              </div>

              <div class="col-md-12 form-group mb-6">
                <label for="c_msg">Pesan</label>
                <textarea class="form-control" rows="7" placeholder="Hi, saya ingin menanyakan..." id="c_msg"></textarea>
              </div>
            </div>
